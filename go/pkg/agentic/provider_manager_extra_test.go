...
func TestBuiltIns_NewProviderManager_Good(t *testing.T) {
	...
	core.AssertContains(t, manager.Names(), "claude")
}

func TestNilGenerator_NewProviderManager_Bad(t *testing.T) {
	manager := NewProviderManager(nil)
	core.AssertNotNil(t, manager)
	core.AssertContains(t, manager.Names(), "openai")
}

func TestFreshManager_NewProviderManager_Ugly(t *testing.T) {
...
func TestSortedNames_ProviderManager_Names_Good(t *testing.T) {
	manager := NewProviderManager(nil)
	got := manager.Names()
...
func TestEmptyNames_ProviderManager_Names_Bad(t *testing.T) {
...
func TestNilManager_ProviderManager_Names_Ugly(t *testing.T) {
...
func TestCaseInsensitive_ProviderManager_Provider_Good(t *testing.T) {
	manager := NewProviderManager(nil)
...
func TestUnknown_ProviderManager_Provider_Bad(t *testing.T) {
	manager := NewProviderManager(nil)
...
func TestNilManager_ProviderManager_Provider_Ugly(t *testing.T) {
	var manager *ProviderManager
	provider, ok := manager.Provider("claude")
	core.AssertFalse(t, ok)
	core.AssertNil(t, provider)
...
func TestRegisterProvider_ProviderManager_Register_Good(t *testing.T) {
	manager := &ProviderManager{}
...
func TestNilProvider_ProviderManager_Register_Bad(t *testing.T) {
	manager := &ProviderManager{}
...
func TestReplaceProvider_ProviderManager_Register_Ugly(t *testing.T) {
	manager := &ProviderManager{}
...
func TestAvailableProvider_ProviderManager_DefaultProvider_Good(t *testing.T) {
	manager := &ProviderManager{}
...
func TestNoAvailableProvider_ProviderManager_DefaultProvider_Bad(t *testing.T) {
	manager := &ProviderManager{}
...
func TestNilManager_ProviderManager_DefaultProvider_Ugly(t *testing.T) {
	var manager *ProviderManager
	provider := manager.DefaultProvider()
	core.AssertNil(t, provider)
	core.AssertFalse(t, provider != nil)
...
func TestNamedProvider_Provider_Name_Good(t *testing.T) {
...
func TestEmptyName_Provider_Name_Bad(t *testing.T) {
...
func TestUnicodeName_Provider_Name_Ugly(t *testing.T) {
...
func TestNamedModel_Provider_DefaultModel_Good(t *testing.T) {
	provider := newContentProvider("claude", "claude-3.7-sonnet", true, nil)
...
func TestEmptyModel_Provider_DefaultModel_Bad(t *testing.T) {
...
func TestUnicodeModel_Provider_DefaultModel_Ugly(t *testing.T) {
...
func TestAvailableProvider_Provider_IsAvailable_Good(t *testing.T) {
	provider := newContentProvider("claude", "claude-3.7-sonnet", true, nil)
	core.AssertTrue(t, provider.IsAvailable())
	core.AssertEqual(t, true, provider.IsAvailable())
}

func TestUnavailableProvider_Provider_IsAvailable_Bad(t *testing.T) {
...
func TestToggleAvailability_Provider_IsAvailable_Ugly(t *testing.T) {
	provider := newContentProvider("claude", "claude-3.7-sonnet", true, nil)
...
func TestGenerateContent_Provider_Generate_Good(t *testing.T) {
...
func TestMissingGenerator_Provider_Generate_Bad(t *testing.T) {
	provider := newContentProvider("claude", "claude-3.7-sonnet", true, nil)
	text, err := provider.Generate(context.Background(), "Write a release note", nil)
...
func TestRetryGenerate_Provider_Generate_Ugly(t *testing.T) {
	attempts := 0
...
func TestStreamContent_Provider_Stream_Good(t *testing.T) {
	var tokens []string
	provider := newContentProvider("claude", "claude-3.7-sonnet", true, func(_ context.Context, _ string, _ map[string]any) (string, error) {
		return "Draft ready", nil
	})
...
func TestMissingStream_Provider_Stream_Bad(t *testing.T) {
	provider := newContentProvider("claude", "claude-3.7-sonnet", true, nil)
	provider.stream = nil
